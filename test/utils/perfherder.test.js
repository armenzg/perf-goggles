...
const TH = 'https://treeherder.mozilla.org';
...
describe('Perfherder Linux64 data', () => {
  ...
  it('should find Linux64 JetStream pgo subtests data', async () => {
    ...
    console.log(Object.keys(LINUX64_JETSTREAM_EXPECTED_DATA));
    assert.deepEqual(data, LINUX64_JETSTREAM_EXPECTED_DATA);
  });
});
